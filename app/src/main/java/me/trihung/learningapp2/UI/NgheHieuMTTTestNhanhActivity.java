        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sourceID == android.R.drawable.ic_media_play) {
                    ...
                    // Create a new countdown timer or resume the existing one
                    if (c == null) {
                        c = countDownAudio();
                        c.start();
                    } else {
                    ...
                    // Start/resume the seekbar update thread
                    if (t == null || !t.isAlive()) {
                        chaySeekBar();
                    }
...
//            mp.reset();
    ...
    private CountDownTimer countDownAudio() {
        ...
        long remainingTime = mp.getDuration() - mp.getCurrentPosition();
    ...
    private void showCorrect(NgheHieuMoTaTranh ngheHieuMoTaTranh) {
        if (ngheHieuMoTaTranh.getDapAnA().equals(arrayListDe.get(currentQuestion).getDapAnDung())) {
            tvA.setBackgroundResource(R.drawable.bg_answer);
        } else if (ngheHieuMoTaTranh.getDapAnB().equals(arrayListDe.get(currentQuestion).getDapAnDung())) {
            tvB.setBackgroundResource(R.drawable.bg_answer);
        } else if (ngheHieuMoTaTranh.getDapAnC().equals(arrayListDe.get(currentQuestion).getDapAnDung())) {
            tvC.setBackgroundResource(R.drawable.bg_answer);
        } else if (ngheHieuMoTaTranh.getDapAnD().equals(arrayListDe.get(currentQuestion).getDapAnDung())) {
